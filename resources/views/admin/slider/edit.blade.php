            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="custom-color">
                        <h4 class="title">Edit Cover Image</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{route('slider.edit',$slider->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-10 offset-2">
                                ...
                                <div class="row">
                                    <label for="image" class="col-md-2 text-right">Banner Image</label>
                                    <div class="col-md-6 form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <textarea type="text" name="description" class="form-control" rows="3">{{$slider->description}}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row">
