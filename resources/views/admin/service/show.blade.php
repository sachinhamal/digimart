        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('service.digi')}}" method="get" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <label for="product_name" class="col-md-2">Blog Name</label>
                                    <div class="col-md-4 form-group">
                                        <input type="text" name="title" value="{{$service->title}}" class="form-control" disabled>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea id="editor" name="description" disabled>{{$service->description}}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <img src="{{url('images/service/'.$service->image)}}" width="400px" alt="{{$service->title}}">    
                                    </div>     
                                </div>
                                <div class="row">
