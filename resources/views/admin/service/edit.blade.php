            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="custom-color">
                        <h4 class="title">Update Service</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('service.update',$service->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <label for="product_name" class="col-md-2">Service Name</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <small class="form-text text-muted"><span class="label label-warning">* Select active to make blog viewable</span>
                                        </small>
                                    </div>
                                </div>
